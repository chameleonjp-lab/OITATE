...
P7「1.0内容完成」の6面進行・記録保存・面別条件はmainへマージ済みです。P4〜P6の手動受入、初見テスト、実機・性能確認は未確認のままです。P7も自動検査だけで受入済みとは扱わず、面4の合図順序、面5・6の種類別経路、初見・端末確認を補正・確認しています。P8の公開候補版、公開ページ、権利表示、公開判断は未開始です。
