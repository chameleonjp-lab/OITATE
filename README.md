...
プロデューサー統括計画のP6「縦切り完成版」の実装候補へ進みました。`?p6=1`で、P5の11体・地形・救助・経路を使い、初回説明、得点、称号、助言、設定、端末内記録、再挑戦を一つの流れで確認できます。`?p5=1`は従来の仮結果画面を維持します。P6はP5の20Hz決定論シミュレーションを利用し、新しい動物や2面目を追加しません。
